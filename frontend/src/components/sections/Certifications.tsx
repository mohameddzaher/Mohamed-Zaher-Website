        ...
        {CERTIFICATIONS.map((c, i) => {
          ...
          return (
            <motion.div
              ...
              className="panel rounded-lg p-4 flex items-start gap-3 hover:border-[var(--color-gold-400)]/30 transition-colors duration-200"
            >
              <div className="h-10 w-10 shrink-0 rounded-lg bg-[var(--color-gold-400)]/10 border border-[var(--color-gold-400)]/30 flex items-center justify-center">
                <Award className="h-4 w-4 text-[var(--color-gold-500)]" />
              </div>
